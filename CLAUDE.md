...
This project is indexed by GitNexus as **Flash-Sale-Concurrency-Engine** (1294 symbols, 3014 relationships, 98 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
