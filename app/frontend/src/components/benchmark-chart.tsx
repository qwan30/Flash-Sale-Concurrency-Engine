...
import type { BenchmarkRunSummary, OrderStrategy } from "@/lib/types";
...
export function BenchmarkChart({ rows }: BenchmarkChartProps) {
  ...
  return (
    <div ref={containerRef} className="h-full min-h-[300px] w-full overflow-x-auto">
      {width > 0 ? (
      <BarChart width={width} height={300} data={rows} margin={{ left: 8, right: 8 }}>
