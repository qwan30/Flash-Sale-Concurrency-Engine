...
/**
 * Two-tier read cache for ticket fixture details.
 *
 * <p>A Guava local cache absorbs repeat reads in-process, Redis backs it across instances, and a
 * distributed lock guards the database load so a cache miss under load does not stampede MySQL.
 */
@Service
@Slf4j
