...
- The target working tree contains pre-existing unrelated changes in `.env`, `app/frontend/benchmark/`, `app/frontend/e2e/reports/index.html`, `docs/PORTFOLIO_DEMO_VIDEO_SCRIPT_VI.md`, `plan.md`, and `reference/`; these paths remain outside this documentation checkpoint's staging scope.
