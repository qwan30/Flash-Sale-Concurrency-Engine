...
This project is indexed by GitNexus as **Flash-Sale-Concurrency-Engine** (1479 symbols, 3356 relationships, 109 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
