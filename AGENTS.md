...
This project is indexed by GitNexus as **Flash-Sale-Concurrency-Engine** (1296 symbols, 3017 relationships, 99 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
